...
#   S1  Plain CoAP, port 5683   APP_CLOUD_SECURITY_NONE
#   S2  CoAP + OSCORE, port 5683  APP_CLOUD_SECURITY_OSCORE
#   S3  CoAP + DTLS, port 5684  APP_CLOUD_SECURITY_DTLS
#   S4  DTLS + OSCORE, port 5684  APP_CLOUD_SECURITY_DTLS_OSCORE   ← thesis target
#
# Options:
